                   ...
                   <div class="page-header float-left">
                       <div class="page-title">
                         @foreach ($categoriesusers as $categorieuser)
                           <h1>Edit Berita :: Penulis (<b>{{ $categorieuser->name }})</b></h1>
                         @endforeach
                       </div>
                   </div>
               </div>
                   ...
                   <div class="page-header float-right">
                       <div class="page-title">
                           <ol class="breadcrumb text-right">
                               ...
                               <li><a href="{{ route('admin.news.edit', $id) }}">News</a></li>
                 ...
                 <div class="col-xs-7 col-sm-7">
                     <div class="card">
                         <div class="card-header">
                            ...
                            <form action="{{ route('admin.news.update', $id) }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              {{-- {{ method_field('PUT') }} --}}
                               <div class="card-body card-block">
                                      ...
                                      <input id="judul_berita_ina" type="text" name="judul_berita_ina" class="form-control"  value="@foreach ($categoriesusers as $categorieuser) {{ $categorieuser->judul_berita_ina }} @endforeach" style="background-color: lightpink;" required  autofocus>
                                         </div>
                                     ...
                                     {{-- <div class="form-group">
                                       ...
                                       <div class="input-group">
                                           <div class="input-group-addon"><i class="fa fa-pencil-square"></i></div>
                                      <input id="judul_berita_eng" type="text" class="form-control" name="judul_berita_eng" value="@foreach ($categoriesusers as $categorieuser) {{ $categorieuser->judul_berita_eng }}  @endforeach" style="background-color: lightpink;" required  autofocus>
                                       </div>
                                     ...
                                     <div class="form-check">
                                                <div class="radio">
                                                 <label for="radio1" class="form-check-label ">
                                                     <input type="radio" id="radio1" name="trending" value="Y" @foreach ($categoriesusers as $categorieuser) @if ($categorieuser->trending === 'Y' )  checked  @endif @endforeach class="form-check-input">Yes
                                                 </label>
                                                </div>
                                                <div class="radio">
                                                 <label for="radio2" class="form-check-label ">
                                                     <input type="radio" id="radio2" name="trending" value="N" @foreach ($categoriesusers as $categorieuser) @if ($categorieuser->trending === 'N' ) checked  @endif @endforeach class="form-check-input">No
                                                 </label>
                                                </div>
                                     </div>
                                     </div>
                                      ...
                                      <div class="input-group-addon"><i class="fa fa-bullhorn"></i></div>&nbsp&nbsp&nbsp&nbsp
                                       <!--- dari controller harus pakai ::   public function edit($news)   --->
                                         <div class="form-check">
                                                <div class="radio">
                                                 <label for="radio1" class="form-check-label ">
                                                     <input type="radio" id="radio1" name="headline" value="Y" @foreach ($categoriesusers as $categorieuser) @if ($categorieuser->headline === 'Y' )  checked  @endif @endforeach class="form-check-input">Yes
                                                 </label>
                                                </div>
                                                <div class="radio">
                                                 <label for="radio2" class="form-check-label ">
                                                     <input type="radio" id="radio2" name="headline" value="N" @foreach ($categoriesusers as $categorieuser) @if ($categorieuser->headline === 'N' ) checked  @endif @endforeach class="form-check-input">No
                                                 </label>
                                                </div>
                                    </div>
                                    </div>
                                     ...
                                     <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-cogs"></i></div>&nbsp&nbsp&nbsp&nbsp
                                         <div class="form-check">
                                                <div class="radio">
                                                 <label for="radio1" class="form-check-label ">
                                                     <input type="radio" id="radio1" name="aktif" value="Y" @foreach ($categoriesusers as $categorieuser) @if ($categorieuser->aktif === 'Y' ) checked  @endif @endforeach class="form-check-input">Yes
                                                 </label>
                                                </div>
                                                <div class="radio">
                                                 <label for="radio2" class="form-check-label ">
                                                     <input type="radio" id="radio2" name="aktif" value="N" @foreach ($categoriesusers as $categorieuser) @if ($categorieuser->aktif === 'N' ) checked  @endif @endforeach class="form-check-input">No
                                                 </label>
                                                </div>
                                              </div>
                                           </div>
                                     ...
                                     <div class="card">
                                         ...
                                         <div class="card-body">
                                           <select name="nama_kategori" class="standardSelect" tabindex="1" required>
                                               @foreach ($categoriesusers as $categorieuser)
                                                 @if ($categorieuser->id >= 1)
                                                   <option value="{{$categorieuser->id}}" style="background-color: lightpink;" selected > {{ $categorieuser->nama_kategori }} </option>
                                                 @endif
                                             @endforeach
                                             @foreach ($kategori as $kategori)
                                               @if ($categorieuser->id > 0)
                                              ...
                                              <div class="form-check" style=" background-color: lightpink; height: 195px; overflow-y: auto; ">
                                                  <div class="checkbox">
                                                    <label><b><font style="color:blue">Tags saat ini : *</font></b></label><br>
                                                      @foreach ($categoriesusers as $categorieuser)
                                                           <input type="checkbox"  name="tag[]" value="{{ $categorieuser->tag }}" checked  >
                                                           <label><b>{!! $categorieuser->tag !!}</b></label>
                                                      @endforeach
                                           ...
                                           <div class="card-body card-block">
                                               <div class="form-group" style=" background-color: lightyellow;">
                                                   ...
                                                   <div class="input-group" >
                                                       ...
                                                       <textarea id="isiberitaina" name="isi_berita_ina"  rows="8" cols="100"> @foreach ($categoriesusers as $categorieuser) {!! $categorieuser->isi_berita_ina !!} @endforeach</textarea>
                                  ...
                                  <div class="card">
                                      ...
                                      <div class="card-body card-block">
                                          <div class="form-group" style=" background-color: lightyellow;">
                                              ...
                                              <div class="input-group">
                                                  <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                  <textarea id="isiberitaeng" name="isi_berita_eng"  rows="8" cols="100" > @foreach ($categoriesusers as $categorieuser) {!! $categorieuser->isi_berita_eng !!} @endforeach</textarea>
                                              </div>
                                              <small class="form-text text-muted"></small>
                                          </div>
                                      </div>
                                   ...
                                   <div class="card">
                                       ...
                                       <div class="card-body card-block">
                                           <div class="form-group">
                                               ...
                                               <div class="input-group">
                                                   <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                     <input id="datepicker" name="tanggal" class="form-control" value=" @foreach ($categoriesusers as $categorieuser) {{ $categorieuser->tanggal }} @endforeach " style=" background-color: lightgreen;">
                               ...
                               <div class="col-xs-1 col-sm-6">
                                 <div class="card">
                                     ...
                                     <div class="card-body card-block align-self-center">
                                         <div class="form-group">
                                            <a href="{{ asset('uploads/berita/' . $categorieuser->gambar_berita) }}" target="_blank">
                                             <img src="@foreach ($categoriesusers as $categorieuser) {!! asset('uploads/berita/' . $categorieuser->gambar_berita) !!} @endforeach" border="0" width="200px" />
                                            </a>
                                        </div>
                                ...
                                <div class="input-group">
                                  <div class="col col-md-12">
                                        <label for="file-multiple-input" class=" form-control-label"><strong>Gambar Berita</strong> 
                                            <small>Upload Gambar ke : Maks. 300 Kb
                                            @if ($categorieuser->video !== null)
                                               {{"Status :: "}} <b> {{ "OK" }} </b>
                                            @else
                                               {{"Status ::"}} <b> {{ "Empty" }} </b>
                                            @endif   
                                  ...
                                  <div class="col-1 col-md-12">
                                      {{-- <input type="text" name="gambar_berita" class="form-control-file" value=" @foreach ($categoriesusers as $categorieuser) {!! $categorieuser->gambar_berita !!} @endforeach " style=" background-color: lightgreen;"> --}}
                                  </div>
                                </div>
                             </div>
                             <div class="form-group">
                                <div class="input-group">
                                  ...
                                  <div class="col-1 col-md-12">
                                    <textarea name="video" id="video" cols="130" rows="3" style="background-color: lightgreen;">@foreach ($categoriesusers as $categorieuser) {!! $categorieuser->video !!} @endforeach</textarea>
                                      {{-- <input type="text" name="video" class="form-control-file" 
                                      value=" @foreach ($categoriesusers as $categorieuser) {!! $categorieuser->video !!} @endforeach " 
                                      style=" background-color: lightgreen;"> --}}
                                  </div>
                                </div>
                             </div>
                              ...
                              <div class="card">
                                ...
                                <div class="card-body">
                                   ...
                                   <div class="card-body">
                                    ...
                                    value=" @foreach ($categoriesusers as $categorieuser) {!! $id !!} @endforeach " 
                                    style=" background-color: lightgreen;">
