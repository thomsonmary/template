                                      ...
                                      <div class="form-group">
                                         ...
                                         <div class="input-group">
                                             ...
                                             class="form-control @error('judul_berita_ina') is-invalid @enderror"
                                               name="judul_berita_ina" value="{{ $categorie->pivot->judul_berita_ina }}" style="background-color: lightpink;" required  autofocus>
                                         </div>
                                     ...
                                     <div class="form-group">
                                       ...
                                       <div class="input-group">
                                           ...
                                           class="form-control @error('judul_berita_eng') is-invalid @enderror"
                                             name="judul_berita_eng" value="{{ $categorie->pivot->judul_berita_eng }}" style="background-color: lightpink;" required  autofocus>
                                           @endforeach
                                       </div>
                                     ...
                                     <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-cogs"></i></div>&nbsp&nbsp&nbsp&nbsp
                                         <div class="form-check">
                                                ...
                                                <div class="radio">
                                                 <label for="radio2" class="form-check-label ">
                                                     <input type="radio" id="radio2" name="aktif" value="N" @if ($categorie->pivot->aktif === 'N' ) checked  @endif class="form-check-input">No
                                                 </label>
                                                </div>
                                              </div>
                                           </div>
                                           ...
                                           <div class="card-body card-block">
                                               <div class="form-group" style=" background-color: lightyellow;">
                                                   ...
                                                   <div class="input-group" >
                                                       ...
                                                       @foreach ($news->categories as $categorie)
                                                       <textarea id="isiberitaina" name="isi_berita_ina"  rows="8" cols="100">{!! $categorie->pivot->isi_berita_ina !!}</textarea>
                                                       @endforeach
                                                   </div>
                                      ...
                                      <div class="card-body card-block">
                                          <div class="form-group" style=" background-color: lightyellow;">
                                              ...
                                              <div class="input-group">
                                                  <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                  @foreach ($news->categories as $categorie)
                                                  <textarea id="isiberitaeng" name="isi_berita_eng"  rows="8" cols="100" >{!! $categorie->pivot->isi_berita_eng !!}</textarea>
                                                  @endforeach
                                              </div>
                                              <small class="form-text text-muted"></small>
                                          </div>
                                   ...
                                   <div class="card">
                                       ...
                                       <div class="card-body card-block">
                                           <div class="form-group">
                                               ...
                                               <div class="input-group">
                                                   <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                     <input id="datepicker" name="tanggal" class="form-control" value="{{ $categorie->pivot->tanggal }}" style=" background-color: lightgreen;">
