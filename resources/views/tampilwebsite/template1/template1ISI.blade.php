            ...
            <div class="single-sidebar-widget p-30">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="{{ asset('uploads/berita/' . $mostpopular->gambar_berita) }}" alt="" >
                    </div>
        ...
        <div class="mag-posts-content mt-30 mb-30 p-30 box-shadow">
            ...
            <div class="trending-now-posts mb-30">
                ...
                <div class="trending-post-slides owl-carousel">
                    ...
                    <div class="single-trending-post">
                        @foreach ($trendingnews->slice(0, 1) as $trending)
                        <img src="{{ asset('uploads/berita/' . $trending->gambar_berita) }}" alt="" >
                        <div class="post-content">
                            <a href="{{ route('news', $trending->sluk ) }}" 
                                class="post-cata">{!! substr($trending->judul_berita_ina, 0, 30) !!}
                            </a>                            
                            {{-- <a href="#" class="post-cata">Video</a> --}}
                            <a href="{{ route('news', $trending->sluk ) }}" class="post-title">{!! substr($trending->judul_berita_ina, 0, 15) !!}</a>
                        </div>
                        @endforeach
                    </div> 
                    <div class="single-trending-post">
                        @foreach ($trendingnews->slice(1, 1) as $trending)
                        <img src="{{ asset('uploads/berita/' . $trending->gambar_berita) }}" alt="" >
                        <div class="post-content">
                            <a href="{{ route('news', $trending->sluk ) }}" 
                                class="post-cata">{!! substr($trending->judul_berita_ina, 0, 30) !!}
                    ...
                    <div class="single-trending-post">
                        @foreach ($trendingnews->slice(2, 1) as $trending)
                        <img src="{{ asset('uploads/berita/' . $trending->gambar_berita) }}" alt="" >
                        <div class="post-content">
                            <a href="{{ route('news', $trending->sluk ) }}" 
                                class="post-cata">{!! substr($trending->judul_berita_ina, 0, 30) !!}
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            ...
                            <div class="single-featured-post">
                                <!-- Thumbnail -->
                                @foreach ($featurednews->slice(4, 1) as $featured)
                                <div class="post-thumbnail mb-50">
                                    <img src="{{ asset('uploads/berita/' . $featured->gambar_berita) }}" alt="" >
                                    <a href="{{ route('news', $featured->sluk ) }}" 
                                ...
                                <div class="post-content">
                                    <div class="post-meta">
                                        <a href="#">{{ $featured->tanggal }}</a>
                                        <a href="#">{{ $featured->name }}</a>
                                    </div>
                                    <a href="{{ route('news', $featured->sluk ) }}" class="post-title">
                                        {{ $featured->judul_berita_ina }}
                                    </a>
                                    <p>
                                        {!! substr($featured->isi_berita_ina, 0, 150) !!}
                                    </p>
                                        <a href="{{ route('news', $featured->sluk ) }}">[...]</a>
                        ...
                        <div class="col-12 col-lg-5">
                            ...
                            <div class="featured-video-posts-slide owl-carousel">
                                ...
                                <div class="single--slide">
                                    <!-- Single Blog Post -->
                                    @foreach ($featurednews->slice(1, 3) as $tampillima)
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                    <img src="{{ asset('uploads/berita/' . $tampillima->gambar_berita) }}" alt="" >
                                        </div>
                                        <div class="post-content">
                                ...
                                <div class="single--slide">
                                    <!-- Single Blog Post -->
                                    @foreach ($featurednews->slice(2, 3) as $tampillima)
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                    <img src="{{ asset('uploads/berita/' . $tampillima->gambar_berita) }}" alt="" >
                                        </div>
            ...
            <div class="most-viewed-videos mb-30">
                ...
                <div class="most-viewed-videos-slide owl-carousel">
                    ...
                    <div class="single-blog-post style-4">
                        @foreach($mostviews->sortByDesc('view')->slice(0, 2) as $mostviewed)
                        <div class="post-thumbnail">
                        <img src="{{ asset('uploads/berita/' . $mostviewed->gambar_berita) }}" alt="" >
                    ...
                    <div class="single-blog-post style-4">
                        @foreach($mostviews->sortByDesc('view')->slice(1, 2) as $mostviewed)
                        <div class="post-thumbnail">
                        <img src="{{ asset('uploads/berita/' . $mostviewed->gambar_berita) }}" alt="" >
                            {{-- <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a> --}}
                            <span class="video-duration">{{ $mostviewed->view }}</span>
                    ...
                    <div class="single-blog-post style-4">
                        @foreach($mostviews->sortByDesc('view')->slice(2, 2) as $mostviewed)
                        <div class="post-thumbnail">
                        <img src="{{ asset('uploads/berita/' . $mostviewed->gambar_berita) }}" alt=""  >
                            {{-- <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a> --}}
                            <span class="video-duration">{{ $mostviewed->view }}</span>
            ...
            <div class="sports-videos-area">
                ...
                <div class="sports-videos-slides owl-carousel mb-30">
                    <!-- Single Featured Post -->
                    <div class="single-featured-post">
                        @foreach ($categoriesusers->slice(1, 1) as $bukanheadline)
                        <!-- Thumbnail -->
                        <div class="post-thumbnail mb-50">
                        <img src="{{ asset('uploads/berita/' . $bukanheadline->gambar_berita) }}" alt=""  >
                            {{-- <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a> --}}
                        </div>
                        <!-- Post Contetnt -->
                        <div class="post-content">
                    ...
                    <!-- Single Featured Post -->
                    <div class="single-featured-post">
                        @foreach ($categoriesusers->slice(2, 1) as $bukanheadline)
                        <!-- Thumbnail -->
                        <div class="post-thumbnail mb-50">
                        <img src="{{ asset('uploads/berita/' . $bukanheadline->gambar_berita) }}" alt=""  >
                            {{-- <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a> --}}
                    ...
                    <!-- Single Featured Post -->
                    <div class="single-featured-post">
                        @foreach ($categoriesusers->slice(3, 1) as $bukanheadline)
                        <!-- Thumbnail -->
                        <div class="post-thumbnail mb-50">
                        <img src="{{ asset('uploads/berita/' . $bukanheadline->gambar_berita) }}" alt=""  >
                            {{-- <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a> --}}
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        @foreach($categoriesusers->slice(1, 4) as $tampilakhir)
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                        <img src="{{ asset('uploads/berita/' . $tampilakhir->gambar_berita) }}" alt=""  >
                            </div>
                            <div class="post-content">
                    ...
                    <!-- Single Blog Post -->
                    <div class="col-12 col-lg-6">
                        @foreach($categoriesusers->slice(2, 4) as $tampilakhir)
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                        <img src="{{ asset('uploads/berita/' . $tampilakhir->gambar_berita) }}" alt="" >
                            </div>
                    ...
                    <!-- Single Blog Post -->
                    <div class="col-12 col-lg-6">
                        @foreach($categoriesusers->slice(3, 4) as $tampilakhir)
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                        <img src="{{ asset('uploads/berita/' . $tampilakhir->gambar_berita) }}" alt="" >
                            </div>
                    ...
                    <!-- Single Blog Post -->
                    <div class="col-12 col-lg-6">
                        @foreach($categoriesusers->slice(4, 4) as $tampilakhir)
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                        <img src="{{ asset('uploads/berita/' . $tampilakhir->gambar_berita) }}" alt="" >
                            </div>
