    ...
    <section class="mag-posts-area d-flex flex-wrap">
        ...
        <div class="post-sidebar-area left-sidebar mt-30 mb-30 bg-white box-shadow">
            ...
            <div class="single-sidebar-widget p-30">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="{{asset("5.template1/img/bg-img/4.jpg")}}" alt="">
                    </div>
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="{{asset("5.template1/img/bg-img/5.jpg")}}" alt="">
                    </div>
                    <div class="post-content">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="{{asset("5.template1/img/bg-img/6.jpg")}}" alt="">
                    </div>
                    <div class="post-content">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="{{asset("5.template1/img/bg-img/7.jpg")}}" alt="">
                    </div>
                    <div class="post-content">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="{{asset("5.template1/img/bg-img/8.jpg")}}" alt="">
                    </div>
                    <div class="post-content">
            ...
            <div class="single-sidebar-widget p-30">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="{{asset("5.template1/img/bg-img/9.jpg")}}" alt="">
                    </div>
                    <div class="post-content">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="{{asset("5.template1/img/bg-img/10.jpg")}}" alt="">
                    </div>
                    <div class="post-content">
                        <a href="single-post.html" class="post-title">Choose The Perfect Accommodations</a>
                        <div class="post-meta d-flex justify-content-between">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="{{asset("5.template1/img/bg-img/11.jpg")}}" alt="">
                    </div>
                    <div class="post-content">
            ...
            <div class="trending-now-posts mb-30">
                ...
                <div class="trending-post-slides owl-carousel">
                    ...
                    <div class="single-trending-post">
                        <img src="{{asset("5.template1/img/bg-img/19.jpg")}}" alt="">
                        <div class="post-content">
                    ...
                    <!-- Single Trending Post -->
                    <div class="single-trending-post">
                        <img src="{{asset("5.template1/img/bg-img/20.jpg")}}" alt="">
                        <div class="post-content">
                    ...
                    <!-- Single Trending Post -->
                    <div class="single-trending-post">
                        <img src="{{asset("5.template1/img/bg-img/21.jpg")}}" alt="">
                        <div class="post-content">
                        ...
                        <div class="col-12 col-lg-7">
                            ...
                            <div class="single-featured-post">
                                ...
                                <div class="post-thumbnail mb-50">
                                    <img src="{{asset("5.template1/img/bg-img/22.jpg")}}" alt="">
                            ...
                            <div class="featured-video-posts-slide owl-carousel">
                                ...
                                <div class="single--slide">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="{{asset("5.template1/img/bg-img/23.jpg")}}" alt="">
                                        </div>
                                        <div class="post-content">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="{{asset("5.template1/img/bg-img/24.jpg")}}" alt="">
                                        </div>
                                        <div class="post-content">
                                            <a href="single-post.html" class="post-title">A Guide To Rocky Mountain Vacations</a>
                                            <div class="post-meta d-flex">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="{{asset("5.template1/img/bg-img/25.jpg")}}" alt="">
                                        </div>
                                        <div class="post-content">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="{{asset("5.template1/img/bg-img/26.jpg")}}" alt="">
                                        </div>
                                        <div class="post-content">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="{{asset("5.template1/img/bg-img/27.jpg")}}" alt="">
                                        </div>
                                        <div class="post-content">
            ...
            <div class="most-viewed-videos mb-30">
                ...
                <div class="most-viewed-videos-slide owl-carousel">
                    ...
                    <div class="single-blog-post style-4">
                        <div class="post-thumbnail">
                            <img src="{{asset("5.template1/img/bg-img/28.jpg")}}" alt="">
                            <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a>
                    ...
                    <div class="single-blog-post style-4">
                        <div class="post-thumbnail">
                            <img src="{{asset("5.template1/img/bg-img/29.jpg")}}" alt="">
                            <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a>
                            <span class="video-duration">09:27</span>
                        </div>
                        <div class="post-content">
                    ...
                    <div class="single-blog-post style-4">
                        <div class="post-thumbnail">
                            <img src="{{asset("5.template1/img/bg-img/30.jpg")}}" alt="">
                            <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a>
                            <span class="video-duration">09:27</span>
                        </div>
                        <div class="post-content">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="{{asset("5.template1/img/bg-img/31.jpg")}}" alt="">
                            </div>
                            <div class="post-content">
                                <a href="single-post.html" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="{{asset("5.template1/img/bg-img/32.jpg")}}" alt="">
                            </div>
                            <div class="post-content">
                                <a href="single-post.html" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="{{asset("5.template1/img/bg-img/33.jpg")}}" alt="">
                            </div>
                            <div class="post-content">
                                <a href="single-post.html" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="{{asset("5.template1/img/bg-img/34.jpg")}}" alt="">
                            </div>
                            <div class="post-content">
                                <a href="single-post.html" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
